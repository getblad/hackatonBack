...
[create_time] [datetime] NOT NULL CONSTRAINT [DF_EventTeam_create_time] DEFAULT (getdate()),
[update_time] [datetime] NOT NULL CONSTRAINT [DF_EventTeam_update_time] DEFAULT (getdate()),
